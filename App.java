...
public class App {
  public static void main(String[] args) {
    ...
    Animal dog = new Animal(3, "Canis lupus familiaris", "Labrador retriever",  "Tripod", 2, 35, 17, 50);
    Animal cat = new Animal(4, "Felis catus", "Domestic shorthair",  "Moe", 4, 15, 1, 2);
    Animal snake = new Animal(0, "Pantherophis guttatus", "Anery amely",  "Concetta",  6, 2, 1, 5);
